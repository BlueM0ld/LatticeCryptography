...
# This file was *autogenerated* from the file coppersmith_univariate.sage
...
def coppersmith_univariate(N, c, known_prefix, unknown_length, e):
    ...
    shift = Integer(_sage_const_35 ) ** unknown_length
    ...
    if roots:
        unknown_part = roots[_sage_const_0 ][_sage_const_0 ]
        recovered_message = known_prefix_int + unknown_part
